            ...
            <div class="d-flex align-items-center">
                ...
                <a class="navbar-brand" href="index.html">
                    <div class="d-flex align-items-center py-3"><img class="me-2"
                                                                     src="{{asset('back/assets/img/icons/spot-illustrations/falcon.png')}}"
                                                                     alt="" width="40"/><span class="font-sans-serif">Buta</span>
                    </div>
                </a>
            </div>
                    ...
                    <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if(Request::segment(2)=="dashboard") active @endif"
                               href="{{route('admin.dashboard',['locale'=>app()->getLocale()])}}" role="button" aria-expanded="false">
                                <div class="d-flex align-items-center">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link @if(Request::segment(3)=="questanswer") active @endif"
                               href="{{route('admin.questanswer.index',['locale'=>app()->getLocale()])}}" role="button"
                               aria-expanded="false">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if(Request::segment(3)=="privacypolicy") active @endif"
                               href="{{route('admin.privacypolicy.index',['locale'=>app()->getLocale()])}}"
...
{{--                        <li class="nav-item">--}}
{{--                            <a class="nav-link @if(Request::segment(3)=="social") active @endif"--}}
{{--                               href="{{route('admin.social.index',['locale'=>app()->getLocale()])}}" role="button"--}}
{{--                               aria-expanded="false">--}}
{{--                                <div class="d-flex align-items-center">--}}
{{--                                    <span class="nav-link-icon">--}}
...
{{--                        </li>--}}
                        <li class="nav-item">
                            <a class="nav-link @if(Request::segment(3)=="settings") active @endif"
                               href="{{route('admin.settings.index',['locale'=>app()->getLocale()])}}" role="button"
                               aria-expanded="false">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon">
...
{{--                        <li class="nav-item">--}}
{{--                            <a class="nav-link @if(Request::segment(3)=="currency") active @endif"--}}
{{--                               href="{{route('admin.currency.index',['locale'=>app()->getLocale()])}}" role="button"--}}
{{--                               aria-expanded="false">--}}
{{--                                <div class="d-flex align-items-center">--}}
{{--                                    <span class="nav-link-icon">--}}
...
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
{{--                            <a class="nav-link @if(Request::segment(3)=="driverstatus") active @endif"--}}
{{--                               href="{{route('admin.driverstatus.index',['locale'=>app()->getLocale()])}}" role="button"--}}
{{--                               aria-expanded="false">--}}
{{--                                <div class="d-flex align-items-center">--}}
{{--                                    <span class="nav-link-icon">--}}
...
{{--                        </li>--}}
                        <li class="nav-item">
                            <a class="nav-link @if(Request::segment(3)=="carbrands") active @endif"
                               href="{{route('admin.carbrands.index',['locale'=>app()->getLocale()])}}" role="button"
                               aria-expanded="false">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon">
                                       <i class="fas fa-user-check"></i>
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if(Request::segment(3)=="cars") active @endif"
                               href="{{route('admin.cars.index',['locale'=>app()->getLocale()])}}" role="button"
                               aria-expanded="false">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if(Request::segment(3)=="tenants") active @endif"
                               href="{{route('admin.tenants.index',['locale'=>app()->getLocale()])}}" role="button"
                               aria-expanded="false">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon">
                ...
                <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-xxl-3">
                                            <div class="nav flex-column mt-xxl-4 pt-xxl-1"><a
                                                    ...
                                                    class="nav-link py-1 link-600 fw-medium"
                                                    href="modules/components/videos/embed.html">Embed</a></div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6 col-xxl-3">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button"
                        ...
                        <div class="dropdown-menu dropdown-menu-card border-0 mt-0" aria-labelledby="documentations">
                            <div class="bg-white dark__bg-1000 rounded-3 py-2"><a
                                    class="dropdown-item link-600 fw-medium" href="documentation/getting-started.html">Getting
                        ...
                        <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                            <div class="bg-white dark__bg-1000 rounded-2 py-2">
                                <a class="dropdown-item"
                                   href="{{route('admin.logout',['locale'=>app()->getLocale()])}}">Logout</a>
                            </div>
                        </div>
                    </li>
                </ul>
                                                ...
                                                <div class="notification-avatar">
                                                    <div class="avatar avatar-2xl me-3">
                                                        <img class="rounded-circle"
                                                             src="{{asset('back/assets/img/team/1-thumb.png')}}"
                                                             alt=""/>
                                                    </div>
                                                </div>
                ...
                <div class="card-header d-flex flex-between-center">
                    <div class="language-switcher">
                        <a href="{{ route('setLocale', 'en') }}"
                           class='btn btn-sm  {{app()->getLocale()=='en'?'btn-success active':'btn-secondary'}} me-2'>En</a>
                        <a href="{{ route('setLocale', 'az') }}"
                           class='btn btn-sm {{app()->getLocale()=='az'?'btn-success active':'btn-secondary'}} me-2'>Az</a>
                    </div>
