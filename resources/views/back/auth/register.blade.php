...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/simple/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Jan 2022 06:50:28 GMT -->
...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Buta | Dashboard &amp; Web App Template</title>
...
<main class="main" id="top">
    <div class="container" data-layout="container">
        ...
        <div class="row flex-center min-vh-100 py-6">
            ...
            <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a class="d-flex flex-center mb-4" href="../../../index.html"><img class="me-2" src="../../../assets/img/icons/spot-illustrations/falcon.png" alt="" width="58" /><span class="font-sans-serif fw-bolder fs-5 d-inline-block">Buta</span></a>
                <div class="card">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <form action="{{route('admin.getregister',['locale'=>app()->getLocale()])}}" method="post">
                            @csrf
                            <div class="mb-3"><input class="form-control" type="text" name="name" autocomplete="on" placeholder="Name" /></div>
                            <div class="mb-3"><input class="form-control" type="email" name="email" autocomplete="on" placeholder="Email address" /></div>
                            <div class="row gx-2">
                                <div class="mb-3 col-sm-6"><input class="form-control" type="password" name="password" autocomplete="on" placeholder="Password" /></div>
                                <div class="mb-3 col-sm-6"><input class="form-control" type="password" name="password_confirm" autocomplete="on" placeholder="Confirm Password" /></div>
                            </div>
