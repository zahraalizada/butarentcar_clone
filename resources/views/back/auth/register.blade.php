...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
          href="{{asset('back/../../../assets/img/favicons/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32"
          href="{{asset('back/../../../assets/img/favicons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16"
          href="{{asset('back/../../../assets/img/favicons/favicon-16x16.png')}}">
        ...
        <div class="row flex-center min-vh-100 py-6">
            ...
            <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a class="d-flex flex-center mb-4"
                                                                           href="../../../index.html"><img class="me-2"
                                                                                                           ...
                                                                                                           alt=""
                                                                                                           width="58"/><span
                        class="font-sans-serif fw-bolder fs-5 d-inline-block">Buta</span></a>
                <div class="card">
                    <div class="card-body p-4 p-sm-5">
                        <div class="row flex-between-center mb-2">
                            ...
                            <div class="col-auto fs--1 text-600"><span class="mb-0 undefined">Have an account?</span>
                                <span><a href="{{route('admin.login',['locale'=>app()->getLocale()])}}">Login</a></span></div>
                        </div>
                        <form action="{{route('admin.getregister',['locale'=>app()->getLocale()])}}" method="post">
                            @csrf
                            <div class="mb-3"><input class="form-control" type="text" name="name" autocomplete="on"
                                                     placeholder="Name"/></div>
                            <div class="mb-3"><input class="form-control" type="email" name="email" autocomplete="on"
                                                     placeholder="Email address"/></div>
                            <div class="row gx-2">
                                <div class="mb-3 col-sm-6"><input class="form-control" type="password" name="password"
                                                                  autocomplete="on" placeholder="Password"/></div>
                                <div class="mb-3 col-sm-6"><input class="form-control" type="password"
                                                                  name="password_confirm" autocomplete="on"
